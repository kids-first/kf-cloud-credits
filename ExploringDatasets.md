...
Once users identify studies for their research project, they have immediate access to open-source files and can request access to the controlled-access files within the datasets through NIH's [database of Genotypes and Phenotypes (dbGaP)](https://www.ncbi.nlm.nih.gov/gap/).
...
---
### Registration- and Controlled-Access Datasets
